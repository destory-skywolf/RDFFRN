...
class ISFFM_Detect(nn.Module):   #add  layer and Rfb 
    ...
    def __init__(self, nc=80, anchors=(), ch=(), multiplier=0.5,rfb=False,inplace=True):  # detection layer
        ...
        self.l0_fusion = ISFFMV5(level=0, multiplier=0.5,rfb=rfb)
        self.l1_fusion = ISFFMV5(level=1, multiplier=0.5,rfb=rfb)
        self.l2_fusion = ISFFMV5(level=2, multiplier=0.5,rfb=rfb)
...
class ISFFMV5(nn.Module):
    def __init__(self, level, multiplier=1, rfb=False, vis=False, act_cfg=True):
        super(ISFFMV5, self).__init__()
        self.level = level
    ...
    def forward(self, x): #l,m,s
        ...
        level_0_weight_v = self.weight_level_1(level_0_resized)
...
class SSSM(nn.Module):
    ...
    def forward(self, x):
        ...
        return  self.rate1*x+self.rate2*out_conv
